...
public class OrderSummaryActivityTest {
    ...
    private static final String emailMessage = "I just ordered a delicious tea from TeaTime. Next time you craving a tea, check them out!";
    ...
    public void clickSendEmailButton_SendsEmail() {
        ...
        // intened(Matcher<Intent> matcher) asserts the given matcher matches one and only one
